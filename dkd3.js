...
let dkdurl = process.env.DKDURL3;
let dkdhd = process.env.DKDHD3;
let dkdbody = process.env.DKDBODY3;
let dkdtxurl = process.env.DKDTXURL3;
let dkdtxhd = process.env.DKDTXHD3;
let dkdtxbody = process.env.DKDTXBODY3;
