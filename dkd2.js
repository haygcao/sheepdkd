...
let dkdurl = process.env.DKDURL2;
let dkdhd = process.env.DKDHD2;
let dkdbody = process.env.DKDBODY2;
let dkdtxurl = process.env.DKDTXURL2;
let dkdtxhd = process.env.DKDTXHD2;
let dkdtxbody = process.env.DKDTXBODY2;
